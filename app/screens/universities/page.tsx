...
import OverviewChart from '@/app/components/Overview';
import GenericTable from '@/app/components/table/GenericTable';
import { useRouter } from 'next/navigation';
import { universityColumns, University } from '@/app/screens/universities/data';
import { ENDPOINTS } from '@/app/api/url/endpoints';
...
export default function Universities() {
  ...
  const handleEdit = (university: University) => {
    router.push(`/screens/universities/edit/${encodeURIComponent(university.name)}`);
  };

  const handleView = (university: University) => {
    router.push(`/screens/universities/view/${encodeURIComponent(university.name)}`);
  };
     ...
     Logout
      ...
      <div className="overflow-x-auto rounded-lg bg-white shadow">
        <GenericTable<University>
          ...
          onAddNew={() => router.push('/screens/universities/add')}
          renderRow={(u) => {
